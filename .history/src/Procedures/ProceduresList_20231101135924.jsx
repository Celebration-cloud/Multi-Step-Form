...
function PersonalInfo({store, handleSubmit}) {
  ...
  const handlePersonalInfo = (e) => {
    ...
    const formData = {
      ...
      number: Number(personalData.phoneNumber)
    }
    handle(formData)
  ...
  return (
    <div className="mobileTab">
      ...
      <input
        style={onfocus ? personalData.name.length < 1 ? { border: "1px solid red" } : {} : { border: "1px solid "}}
        className="formInfo"
        id="name"
        name="name"
