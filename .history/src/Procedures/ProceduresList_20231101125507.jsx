...
function PersonalInfo() {
  ...
  return (
    <div className="mobileTab">
      ...
      <br />
      <div style={{display: "flex", flexDirection: "column", justifyContent: ""}}></div>
      <label className="inputs" htmlFor="name">
        Name{personalData.name.length < 1 && <span style={{color: "red", marginLeft: "auto 100px", fontSize: 10}}>This Field is required</span>}
