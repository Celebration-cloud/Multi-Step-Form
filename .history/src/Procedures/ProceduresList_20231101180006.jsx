  ...
  const handleChange = (event, newAlignment) => {
    ...
    return (
      <div className="mobileTab">
            ...
            <ToggleButton className="selectingPlan" value={item.title}>
              <div className="selectPlan">
                ...
                <div>
                  <h6>{item.title}</h6>
                  <span>
                    ${toggle === false ? item.monthPrice: item.yearPrice}/{toggle === f ? item.month : item.year}
                  </span>
                </div>
              </div>
            </ToggleButton>
        ...
        <div className="monYr">
          <span style={toggle ? { fontWeight: "bolder" } : {}}>Monthly</span>
          ...
          <span style={toggle ? { fontWeight: "bolder" } : {}}>Yearly</span>
        </div>
      </div>
    );
}
