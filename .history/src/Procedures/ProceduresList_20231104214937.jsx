...
/**
 * Renders a form for collecting personal information.
 * @param {Object} props - The component props.
 * @param {Function} props.store - A function to handle storing the personal data.
 * @returns {JSX.Element} - JSX elements representing the form for collecting personal information.
 */
  ...
  return (
    <div className="mobileTab">
      ...
      >
        ...
        {personalData.phoneNumber.length > 3 &&
          personalData.phoneNumber.length < 13 && (
            <span style={{ color: "red", fontSize: 10 }}>Max-length: 11</span>
          )}
      </span>
      <input
        className="formInfo"
  ...
  return (
    <div className="mobileTab">
      ...
      <div className="monYr">
        ...
        <span
          style={toggle === true ? { fontWeight: "bolder", color: "navy" } : {}}
        >
          Yearly
        </span>
      </div>
